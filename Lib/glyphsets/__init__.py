...
def description_per_glyphset(glyphset_name):
    ...
    md += f"The resulting glyphset can be found here: [{glyphset_name}.nam](/Lib/glyphsets/definitions/nam/{glyphset_name}.nam), [{glyphset_name}.glyphs](/Lib/glyphsets/definitions/glyphs/{glyphset_name}.glyphs), as well as part of [CustomFilter_GF_{script}.plist](/Lib/glyphsets/definitions/glyphs/CustomFilter_GF_{script}.plist)\n\n"
    return md, warning
